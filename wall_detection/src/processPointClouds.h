...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	struct line_data
	{
		...
		//int angle_stat; // 1 = parallel, 2 = perpendecular, 0 = else;
		int line_stat; // 1 = front; 2= left;  3 = back; 4 = right
		/* data */
	};
...
public:
	...
	Box_params BoundingBox_params(typename pcl::PointCloud<PointT>::Ptr cluster);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  // RANSACE PLANE SEGMENTATION with initial
    std::pair<typename pcl::PointCloud<PointT>::Ptr, typename pcl::PointCloud<PointT>::Ptr> RANSAC_PlaneSegment_with_init_Scratch(typename pcl::PointCloud<PointT>::Ptr cloud, pcl::ModelCoefficients::Ptr plane_coeff, int maxIterations, float distanceThreshold);
 
	std::pair<line_data, std::pair<typename pcl::PointCloud<PointT>::Ptr, typename pcl::PointCloud<PointT>::Ptr>> RANSAC_LineSegment_Scratch(typename pcl::PointCloud<PointT>::Ptr cloud, int maxIterations, float distanceThreshold, double robot_theta);
